...
SDL_Texture* CType::GetInfo(const int& fontID, int& h_spacing, int& v_spacing)
{
...
SDL_Texture* CType::GetFont(const int& fontID)
{
  SDL_Texture* font = NULL;
  switch (fontID)
  {
    case FONT_DEFAULT:   font = control.CS_Font;     break;
    case FONT_MINI:     font = control.Mini_Font;   break;
    default: break;
  }
...
int CType::GetHSpacing(const int& fontID)
{
  int h_spacing = 0;
...
int CType::GetVSpacing(const int& fontID)
{
  int v_spacing = 0;
...
int CType::GetSymH(const int& fontID)
{
  int symH = 0;
...
void CType::GetXY(const int& fontID, char symbol, SDL_Rect& symRec)
{
...
void CType::GetXY_spec(const int& fontID, char symbol, SDL_Rect& symRec)
{
...
void CType::GetXY(const int& fontID, char symbol, int& X, int& Y, int& W, int& H)
{
  H = GetSymH(fontID);
  switch (fontID)
  {
...
void CType::GetXY_spec(const int& fontID, char symbol, int& X, int& Y, int& W, int& H)
{
  H = GetSymH(fontID);
  switch (fontID)
  {
